class Sentence:
	...
	"""
	def __init__(self, nominals, sentence, nominal_distance, pos_nominals, pos_words, stem_words, label, pos_betweem_nominals):
		self.e1=nominals[0]
		self.e2=nominals[1]
		...
		self.label = label
		self.pos_betweem_nominals = pos_betweem_nominals
